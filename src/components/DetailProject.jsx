...
const DetailProject = ({ data }) => {
  return (
    <motion.div initial={{translateY: 300, opacity: 0}} animate={{translateY: 0, opacity: 1}} transition={{duration: 0.6, ease: ['easeInOut']}} className="flex-1">
      ...
      <a className="underline cursor-pointer" href={data.link}>View Demo</a>
